...
/*-------------Controles: p -->  Pausa ------------------------------
                          o -->  Reversa----------------------------
						  l --> Adelante----------------------------
Al inicio el coarrito se mueve hacia delante, presionas o y se va hacia atras, 
presionas l y se va hacia delante---------------------------------------*/
	...
	if (play) {
		...
		if (r) {
			if (estado == 0) {// estado A
				...
				else {//ya llegue al limite transicion al estado B
			...
			if (estado == 1) {
				rotKit_y = 270;
				if (movKit_x > 0) {// sigo en estado B
					movKit_x += -1.0f;
					//printf("%f \n", movKit_x);
				}
				else {// estado C
			...
			if (estado == 2) {
				rotKit_y = 0;
				if (movKit_z < 150) {//sigo en estado c
					movKit_z += 1.0f;
					//printf("%f \n", movKit_x);
				}
				else {
					
					estado = 1;// cambio a estado B´
				}
			...
			if (estado == 3) {
				...
				if (movKit_x < 180) {
					...
					estado = 2;//regreso al estado en del inicoo
				}
			...
			if (estado == 3) {
				...
				if (movKit_x > 0) {
					...
					estado = 0;//regreso al estado en del inicoo
				}
